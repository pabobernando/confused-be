...
const registerTournamentSchema = {
  ...
  description:
    "Register team for tournament with specified quantity (creates multiple participant entries)",
  body: {
    type: "object",
...
export async function registerTournamentHandler(
  request: FastifyRequest,
  reply: FastifyReply
) {
  try {
    const { tournamentId, teamName, contact, logo, players, quantity } =
      request.body as RegisterTournamentBody;
